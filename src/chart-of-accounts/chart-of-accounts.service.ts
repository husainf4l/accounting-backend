...
export class ChartOfAccountsService {
    ...
    async initializeChartOfAccounts(): Promise<string> {
        ...
        const accounts = [
            ...
            { hierarchyCode: '1.1.5', name: 'long term Cheques', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1' },
            { hierarchyCode: '1.1.4', name: 'Stock', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1' },
            { hierarchyCode: '1.1.3', name: 'Accounts Receivable', accountType: AccountType.ASSET, mainAccount: true, parentHierarchyCode: '1.1' },
            { hierarchyCode: '1.1.3.9', name: 'maria fatol', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.12', name: 'Majd Chuck', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.11', name: 'zxsd', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.10', name: 'sdsadsa', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.1', name: 'Client A', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.8', name: 'al-hussein qasem-abdullah', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.7', name: 'Maria Fatol', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.6', name: 'ssss', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.5', name: 'Maria Fatol', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.4', name: 'alhussein', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.3', name: 'cashmer', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.3.2', name: 'Client B', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.3' },
            { hierarchyCode: '1.1.1', name: 'Cash', accountType: AccountType.ASSET, mainAccount: true, parentHierarchyCode: '1.1' },
            { hierarchyCode: '1.1.1.2', name: 'Office Cash', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.1' },
            { hierarchyCode: '1.1.1.1', name: 'Cash Aramex', accountType: AccountType.ASSET, mainAccount: false, parentHierarchyCode: '1.1.1' },
            ...
            { hierarchyCode: '5', name: 'TRADE EXPENSES', accountType: AccountType.EXPENSE, mainAccount: true, parentHierarchyCode: null },
            { hierarchyCode: '6', name: 'Expenses', accountType: AccountType.EXPENSE, mainAccount: true, parentHierarchyCode: null },
        ];
