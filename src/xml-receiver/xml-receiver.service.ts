...
export class XmlReceiverService {
  ...
  //       unitPrice * (quantity - discount) * 1.16,
  //     );

  //     const allowanceRounded = roundToNine(allowance);

  //     const discountRounded = roundToNine(discount);
  //     // Calculate line extension amount
  //     const lineExtensionAmount = roundToNine(
  //       quantity * (unitPrice - parseFloat(discountRounded)),
  //     );
  ...
  //     const roundingAmount = roundToNine(
  //       parseFloat(lineExtensionAmount) + parseFloat(taxAmountLine),
  //     );

  //     const PayableAmount = roundToNine(TaxInclusiveAmount);
  ...
  //         .txt(roundToNine(allowance).toString())
  //         .up()
  //         .up()

  //         .ele('cac:TaxTotal')
  //         .ele('cbc:TaxAmount', { currencyID: 'JO' })
  //         .txt(taxAmountLine.toString())
  //         .up()
  //         .up()
  ...
  //   const unitPrice = 1; // Unit price of the item
  //   const taxPercent = 16; // VAT percentage
  //   const quantity = 1; // Quantity of the item
  //   const allowance = 0.1; // Discount allowance
  //   const discount = 0.1; // Item discount

  //   // Calculate amounts
  //   const lineExtensionAmount = roundToNine(quantity * (unitPrice - discount)); // Base amount after discount
  //   const taxAmountLine = roundToNine(
  //     (parseFloat(lineExtensionAmount) * taxPercent) / 100,
  //   ); // Tax for the line
  //   const TaxExclusiveAmount = roundToNine(unitPrice * quantity); // Total without tax
  //   const TaxInclusiveAmount = roundToNine(
  //     parseFloat(TaxExclusiveAmount) + parseFloat(taxAmountLine),
  //   ); // Total with tax
  //   const allowanceRounded = roundToNine(allowance); // Allowance
  ...
  //       .txt(taxAmountLine)
  //       .up()
  //       .ele('cac:TaxSubtotal') // Subtotal details within TaxTotal
  //       .ele('cbc:TaxAmount', { currencyID: 'JO' })
  //       .txt(taxAmountLine)
  //       .up()
  //       .ele('cac:TaxCategory')
  ...
  //       .ele('cac:Item')
  //       .ele('cbc:Name')
  //       .txt(invoice.items?.[0]?.name || 'Default Item')
  //       .up()
  //       .up()
  //       .ele('cac:Price')
  //       .ele('cbc:PriceAmount', { currencyID: 'JO' })
